/*
*  Pat Cullen
*  patrickmcullen<at>gmail.com
*  http://pat.cullen.co.za
*  Last updated: Jun. 2013 
*
*  You may use this code as you wish.
*
*  This uses the SDL library, which gives access to read from the Joysticks 
*  plugged into the machine. Presents the reading as a _very_ simple json/http output.
*/
