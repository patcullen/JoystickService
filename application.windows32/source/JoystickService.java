...
public class JoystickService extends PApplet {

 // for the joystick

 // for the mapping: enumerating through the joystick keys
 // for the HTTP json server
...
public void stop() {
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "JoystickService" };
    if (passedArgs != null) {
